...
```{r base ind, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
head(base_finale)
```
...
On a reconstruit les carrières de nos 10 000 individus sur 5 ans. On connaît la position professionnelle chaque année, de l’âge de XX ans jusqu’à XX ans. Cette position est codée de la manière suivante : les codes 1 à 6 correspondent xxX. 
...
```{r dendogram, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r dendogramplot, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
#plot(as.dendrogram(seq.dist), leaflab = "none")
```
